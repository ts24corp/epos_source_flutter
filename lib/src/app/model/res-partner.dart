class ResPartner {
  ...
  dynamic parentId;
  dynamic parentName;
  List<dynamic> partnerCustomLines;
  int partnerGid;
  ...
  dynamic propertyPurchaseCurrencyId;
  ...
  ResPartner(
      ...
      this.propertyPurchaseCurrencyId,
  ...
  ResPartner.fromJson(Map<String, dynamic> json) {
    ...
    if (json["bank_ids"] != null) {
      bankIds =
          List<dynamic>.from(json["bank_ids"] != null ? json["bank_ids"] : []);
    }
    ...
    if (json["channel_ids"] != null) {
      channelIds = List<dynamic>.from(
          json["channel_ids"] != null ? json["channel_ids"] : []);
    }
    if (json["child_ids"] != null) {
      childIds = List<dynamic>.from(
          json["child_ids"] != null ? json["child_ids"] : []);
    }
    city = json['city'];
    color = json['color'];
    ...
    if (json["contract_ids"] != null) {
      contractIds = List<dynamic>.from(
          json["contract_ids"] != null ? json["contract_ids"] : []);
    }
    contractsCount = json['contracts_count'];
    if (json["country_id"] != null) {
      countryId = List<dynamic>.from(
          json["country_id"] != null ? json["country_id"] : []);
    }
    ...
    if (json["meeting_ids"] != null) {
      meetingIds = List<dynamic>.from(
          json["meeting_ids"] != null ? json["meeting_ids"] : []);
    }
    ...
    messagesFromCount = json['messages_from_count'];
    messagesToCount = json['messages_to_count'];
    mobile = json['mobile'];
    name = json['name'];
    opportunityCount = json['opportunity_count'];
    if (json["opportunity_ids"] != null) {
      opportunityIds = List<dynamic>.from(
          json["opportunity_ids"] != null ? json["opportunity_ids"] : []);
    }
    parentId = json['parent_id'];
    parentName = json['parent_name'];
    if (json["partner_custom_lines"] != null) {
      partnerCustomLines = List<dynamic>.from(
          json["partner_custom_lines"] != null
              ? json["partner_custom_lines"]
              : []);
    }
    ...
    if (json["payment_token_ids"] != null) {
      paymentTokenIds = List<dynamic>.from(
          json["payment_token_ids"] != null ? json["payment_token_ids"] : []);
    }
    phone = json['phone'];
    pickingWarn = json['picking_warn'];
    pickingWarnMsg = json['picking_warn_msg'];
    posOrderCount = json['pos_order_count'];
    ...
    propertyPurchaseCurrencyId = json['property_purchase_currency_id'];
    ...
    purchaseWarn = json['purchase_warn'];
    purchaseWarnMsg = json['purchase_warn_msg'];
    ref = json['ref'];
    if (json["ref_company_ids"] != null) {
      refCompanyIds = List<dynamic>.from(
          json["ref_company_ids"] != null ? json["ref_company_ids"] : []);
    }
    saleOrderCount = json['sale_order_count'];
    if (json["sale_order_ids"] != null) {
      saleOrderIds = List<dynamic>.from(
          json["sale_order_ids"] != null ? json["sale_order_ids"] : []);
    }
    saleWarn = json['sale_warn'];
    saleWarnMsg = json['sale_warn_msg'];
    if (json["self"] != null) {
      self = List<dynamic>.from(json["self"] != null ? json["self"] : []);
    }
    ...
    if (json["state_id"] != null) {
      stateId =
          List<dynamic>.from(json["state_id"] != null ? json["state_id"] : []);
    }
    street = json['street'];
    street2 = json['street2'];
    supplier = json['supplier'];
    supplierInvoiceCount = json['supplier_invoice_count'];
    taskCount = json['task_count'];
    if (json["task_ids"] != null) {
      taskIds =
          List<dynamic>.from(json["task_ids"] != null ? json["task_ids"] : []);
    }
    ...
    if (json["user_ids"] != null) {
      userIds =
          List<dynamic>.from(json["user_ids"] != null ? json["user_ids"] : []);
    }
    vat = json['vat'];
    website = json['website'];
    websiteDescription = json['website_description'];
    if (json["website_id"] != null) {
      websiteId = List<dynamic>.from(
          json["website_id"] != null ? json["website_id"] : []);
    }
    ...
    if (json["wishlist_ids"] != null) {
      wishlistIds = List<dynamic>.from(
          json["wishlist_ids"] != null ? json["wishlist_ids"] : []);
    }
    wkDob = json['wk_dob'];
    ...
    xAgency = json['x_agency'];
    xTaxpayerTct = json['x_taxpayer_tct'];
    zip = json['zip'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['messages_from_count'] = this.messagesFromCount;
    data['messages_to_count'] = this.messagesToCount;
    ...
    data['partner_custom_lines'] = this.partnerCustomLines;
    ...
    data['pos_order_count'] = this.posOrderCount;
    ...
    data['property_purchase_currency_id'] = this.propertyPurchaseCurrencyId;
    ...
    data['purchase_warn'] = this.purchaseWarn;
    data['purchase_warn_msg'] = this.purchaseWarnMsg;
    data['ref'] = this.ref;
    ...
    data['supplier_invoice_count'] = this.supplierInvoiceCount;
    data['task_count'] = this.taskCount;
    data['task_ids'] = this.taskIds;
    ...
    data['update_company'] = this.updateCompany;
    ...
    data['x_agency'] = this.xAgency;
    data['x_taxpayer_tct'] = this.xTaxpayerTct;
    data['zip'] = this.zip;
    return data;
  }
}
